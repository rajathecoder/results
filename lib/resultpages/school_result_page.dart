...
import 'package:results/pages/ResultPage.dart';
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("SSLC Results",style: MainStyleFont(),),
                  ],
                ),
              ),
              onTap: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => SslcResult()));
              },
            ),
            SizedBox(height: sHeight(3, context),),
            InkWell(
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("HSC(+1) Results",style: MainStyleFont(),),
                  ],
                ),
              ),
              onTap: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => Hsc1Result()));
              },
            ),
            SizedBox(height: sHeight(3, context),),
            InkWell(
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text("HSC(+2) Results",style: MainStyleFont(),),
                  ],
                ),
              ),
              onTap: (){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => Hsc2Result()));
              },
            ),
          ],
        ),
