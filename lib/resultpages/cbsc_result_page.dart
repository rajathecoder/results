...
import 'package:results/pages/cbsc_page.dart';

class CbscPage extends StatefulWidget {
  const CbscPage({Key? key}) : super(key: key);

  @override
  State<CbscPage> createState() => _CbscPageState();
}

class _CbscPageState extends State<CbscPage> {
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("10th Results",style: MainStyleFont(),),
                    ],
                  ),
                ),
                onTap: (){
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => CbscTen()));
                },
              ),
              SizedBox(height: sHeight(3, context),),
              InkWell(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text("12th Results",style: MainStyleFont(),),
                    ],
                  ),
                ),
                onTap: (){
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => CbseTwo()));
                },
              ),
            ],
          ),
